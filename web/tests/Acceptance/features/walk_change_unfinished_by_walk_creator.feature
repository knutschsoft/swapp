Feature: An administrator can change an unfinished walk
  ...
  Background:
    ...
    Given the following teams exists:
        ...
        | Westhang | admin@gmx.de,lonely@gmx.de | 1-10,3-12, 13 - 90 | client@gmx.de |
    ...
    Given the following walks exists:
        | name   | team     | startTime       | weather | isUnfinished | walkCreator         |
        | Klippe | Westhang | 02.01.2021 7:20 | Sonne   | <true>       | user<lonely@gmx.de> |

  @javascript
  @walkChangeUnfinished
  Scenario: I can change an unfinished walk as a walkCreator
    ...
    Then I wait for test element "walkReflection" to disappear
    Then I wait for test element "rating" to disappear
    Then I wait for test element "commitments" to disappear
