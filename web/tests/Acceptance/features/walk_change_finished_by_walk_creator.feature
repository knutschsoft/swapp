Feature: An administrator can change a finished walk
  ...
  Background:
    ...
    Given the following walks exists:
        | name   | team     | startTime       | endTime         | weather | isUnfinished | walkCreator         |
        | Klippe | Westhang | 02.01.2021 7:20 | 02.01.2021 9:20 | Sonne   | <false>      | user<lonely@gmx.de> |

  @javascript
  @walkChangeFinished
  Scenario: I can change an finished walk as a walkCreator
