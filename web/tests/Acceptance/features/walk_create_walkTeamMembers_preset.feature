Feature: An user can do a walk with preset walkTeamMembers
    ...
    @javascript
    @walkCreate @initialMembersConfig
    Scenario: I do a walk with one wayPoint and will have walkTeamMembers pre selected by my last walk
        ...
        When initialMembersConfig of team "Westhang" is "rundenersteller"
        And I go to "/dashboard"
        Then I wait for "Team 'Westhang'" to appear
        When I click on text "Runde beginnen"
        Then I wait for "Team 'Westhang'" to disappear

        Then I wait for test element "walkTeamMember-brain@gmx.de" to be not selected
        Then I wait for test element "walkTeamMember-pinky@gmx.de" to be selected
        Then I wait for test element "walkTeamMember-karl@gmx.de" to be not selected
