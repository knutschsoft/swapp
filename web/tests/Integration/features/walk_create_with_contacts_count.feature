Feature: Testing walk create resource with contacts count feature
  ...
  @api @walkCreate
  Scenario: I can request /api/walks/create with a team who has isWithContactsCount
