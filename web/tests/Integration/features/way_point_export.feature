...
#    And print last response
    ...
    And the response should contain "id,Ort,Ankunft,Rundenname,Teamname,Teilnehmer,Tageskonzept,Beobachtung,Einzelgespräch,Meeting?,\"direkte Kontakte\",\"Anzahl Personen vor Ort\""
...
#    And print last response
    Then the response status code should be 200
    And the response should contain "Ort,Ankunft,Rundenname,Teamname,Teilnehmer,Tageskonzept,Beobachtung,Einzelgespräch,Meeting?,\"direkte Kontakte\",\"Anzahl Personen vor Ort\",Nutzende,Dudes,\"angetroffene w 7-11\",\"angetroffene m 7-11\",\"angetroffene d 7-11\""
...
#    And print last response
    Then the response status code should be 200
    And the response should contain "Ort,Ankunft,Rundenname,Teamname,Teilnehmer,Tageskonzept,Beobachtung,Einzelgespräch,Meeting?,\"direkte Kontakte\",\"Anzahl Personen vor Ort\",Nutzende,Dudes,\"angetroffene w 7-11\",\"angetroffene m 7-11\",\"angetroffene d 7-11\",Tags"
