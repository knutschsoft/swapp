Feature: Testing walk create resource with counselings feature
    ...
    Background:
        ...
        Given the following teams exists:
            | name     | users       | ageRanges          | client        | isWithCounselings |
    ...
    @api @walkCreate
    Scenario: I can request /api/walks/create with a team who has isWithCounselings disabled
...
#    And print last response
        ...
        And I can find the following walks in database:
            | name            | isWithCounselings |
            | This is my Walk | <false>           |

    @api @walkCreate
    Scenario: I can request /api/walks/create with a team who has isWithCounselings enabled
        Given I am authenticated against api as "karl@gmx.de"
        When I send an api platform "POST" request to "/api/walks/create" with parameters:
            | key             | value                 |
            | team            | teamIri<CA>           |
