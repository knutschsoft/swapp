...
#    And print last response
        ...
        And the JSON nodes should be equal to:
            | @type | Error             |
            | title | An error occurred |
        And the JSON node 'description' should contain 'Item not found for '
        And the JSON node 'description' should contain 'api'
        And the JSON node 'description' should contain 'users'
        And there are exactly 2 walks in database
