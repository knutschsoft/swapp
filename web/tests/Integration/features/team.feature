...
#    And print last JSON response
        And the JSON nodes should be equal to:
            | totalItems                        | 1        |
            | member[0].@type                   | Team     |
            | member[0].name                    | Westhang |
            | member[0].ageRanges[0].rangeStart | 1        |
            | member[0].ageRanges[0].rangeEnd   | 10       |
            | member[0].ageRanges[2].rangeEnd   | 13       |
            | member[0].ageRanges[2].rangeEnd   | 90       |
#      | member[0].users[0]                | userIri<karl@gmx.de> |
