Feature: Testing walk create resource with consumables feature
    ...
    Background:
        ...
        Given the following teams exists:
            | name     | users       | ageRanges          | client        | isWithConsumables |
    ...
    @api @walkCreate
    Scenario: I can request /api/walks/create with a team who has isWithConsumables disabled
...
#    And print last response
        ...
        And I can find the following walks in database:
            | name            | isWithConsumables |
            | This is my Walk | <false>           |

    @api @walkCreate
    Scenario: I can request /api/walks/create with a team who has isWithConsumables enabled
        Given I am authenticated against api as "karl@gmx.de"
        When I send an api platform "POST" request to "/api/walks/create" with parameters:
            | key             | value                 |
            | team            | teamIri<CA>           |
