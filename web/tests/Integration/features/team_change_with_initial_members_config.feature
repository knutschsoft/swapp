Feature: Testing team change resource with initialMembersConfig
    ...
    Background:
        ...
        Given the following teams exists:
            | name     | users        | ageRanges          | client        | isWithSystemicQuestion | initialMembersConfig |
            | Westhang | admin@gmx.de | 1-10,3-12, 13 - 90 | client@gmx.de | <true>                 | rundenersteller      |

    @api @apiTeamChange @initialMembersConfig
    Scenario: I can request /api/teams/change as an admin and change a team with initialMembersConfig
