 ...
 */
final class Version20181118172103 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD ageRanges JSON NOT NULL COMMENT \'(DC2Type:json_document)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team DROP ageRanges');
    }
}
