...
final class Version20190211053518 extends AbstractMigration
{
    ...
    public function preUp(Schema $schema)
    {
        ...
        $query = $this->connection->createQueryBuilder()
            ->select('id, malesChildCount, femalesChildCount, malesKidCount, femalesKidCount, malesYoungAdultCount, femalesYoungAdultCount, malesYouthCount, femalesYouthCount, malesAdultCount, femalesAdultCount')
            ->from('way_point')
            ->getSQL();
    ...
    private function getRange(string $oldInternalName): AgeRange
    {
        switch ($oldInternalName) {
            ...
            case 'femalesAdultCount':
                ...
                break;
            default:
                throw new AbortMigrationException('Unknown old internal name in migration: '.$oldInternalName);
        }
